...
class BookingService {
    static async handleBooking(call_id, data) {
        ...
        try {
            ...
            const [id] = await (0, connection_1.default)('bookings').insert({
            ...
            const calendarResult = await GoogleCalendarService_1.GoogleCalendarService.createTentativeHold({
                booking_code: bookingCode,
                topic: data.entities.topic || 'General Consultation',
            ...
            const docsResult = await GoogleDocsService_1.GoogleDocsService.appendBooking({
            ...
            const draftResult = await GmailService_1.GmailService.createDraft({
                to: advisorEmail,
    ...
    static async handleReschedule(call_id, data) {
        // Stub
